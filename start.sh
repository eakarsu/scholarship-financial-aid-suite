...
PORT="${PORT:-5160}"
DB_NAME="${PGDATABASE:-scholarship_financial_aid_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Scholarship Financial Aid Suite"
echo "======================================="
echo
...
echo "Starting scholarship financial aid suite frontend on http://localhost:$PORT"
echo "Login: admin@scholarship-financial-aid.local / admin123"
