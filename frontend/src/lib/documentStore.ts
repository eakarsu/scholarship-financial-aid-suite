...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Learners Packet', type: 'Learners', owner: 'Education Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Programs Review Bundle', type: 'Programs', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Classes Evidence Set', type: 'Classes', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
