export const AUTH_COOKIE = 'scholarship_financial_aid_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@scholarship-financial-aid.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@scholarship-financial-aid.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@scholarship-financial-aid.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
