...
const entitySeeds = [
  ['records', 'Learners Records', 'Learners priority queue', 'Open', 'Learners exception list', 'Education Lead', '$0'],
  ['programs', 'Programs Records', 'Programs priority queue', 'Review', 'Programs exception list', 'Education Lead', '$0'],
  ['classes', 'Classes Records', 'Classes priority queue', 'Action needed', 'Classes exception list', 'Education Lead', '$0'],
  ['assignments', 'Assignments Records', 'Assignments priority queue', 'Open', 'Assignments exception list', 'Education Lead', '$0'],
  ['assessments', 'Assessments Records', 'Assessments priority queue', 'Review', 'Assessments exception list', 'Operations Lead', '$0'],
  ['schedules', 'Schedules Records', 'Schedules priority queue', 'Action needed', 'Schedules exception list', 'Operations Lead', '$0'],
  ...
  ['engagement', 'Engagement Records', 'Engagement priority queue', 'Open', 'Engagement exception list', 'Governance Lead', '$0'],
