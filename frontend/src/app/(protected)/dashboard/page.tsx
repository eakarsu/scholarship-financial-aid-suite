...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Scholarship Financial Aid Dashboard"
      subtitle="One merged scholarship financial aid view for Learners, Programs, Classes, Assignments, Assessments, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared scholarship financial aid jobs into one surface. Learners, Programs, Classes, Assignments, Assessments, Schedules, documents, audit, and AI are presented as platform features.</div>
